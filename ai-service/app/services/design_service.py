...
def generate_design_models(extracted_requirements: list[str]) -> DesignSuggestionsData:
    """
    ...
    client = _get_client()
    requirements_text = "\n".join(f"- {req}" for req in extracted_requirements)
...
"""
    ...
    try:
        ...
        return DesignSuggestionsData(**data)
